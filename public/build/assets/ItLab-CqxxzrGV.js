...
[Program finished with exit code 0 in 0.038s]`},500)};return(i,l)=>(t(),r(p,{title:`Practice Lab — IT & Networking Coding Lab`},{default:o(()=>[s(`div`,m,[s(`div`,h,[l[4]||=s(`div`,null,[s(`span`,{class:`px-3 py-1 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 text-xs font-bold uppercase tracking-wider`},` 💻 Department of Information Technology & Networking `),s(`h1`,{class:`text-xl md:text-2xl font-black text-white mt-1.5 flex items-center gap-2`},[s(`span`,null,`INTERACTIVE CODING LAB & TERMINAL`)]),s(`p`,{class:`text-xs text-slate-300 mt-1`},` Online GCC C/C++ compiler and Linux terminal sandbox environment for hands-on programming exercises `)],-1),s(`div`,g,[u(a(d),{href:`/student/practice-lab`,class:`px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-medium transition-colors`},{default:o(()=>[...l[2]||=[c(` All Major Labs `,-1)]]),_:1}),s(`button`,{onClick:E,disabled:w.value,class:`px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg transition-all flex items-center gap-1.5`},[...l[3]||=[s(`span`,null,`▶ Run Code (F5)`,-1)]],8,_)])]),s(`div`,v,[s(`div`,y,[l[5]||=s(`div`,{class:`px-4 py-3 bg-slate-950 border-b border-slate-800 flex items-center justify-between`},[s(`div`,{class:`flex items-center gap-2`},[s(`span`,{class:`w-3 h-3 rounded-full bg-red-500/80`}),s(`span`,{class:`w-3 h-3 rounded-full bg-amber-500/80`}),s(`span`,{class:`w-3 h-3 rounded-full bg-emerald-500/80`}),s(`span`,{class:`ml-2 text-xs font-mono text-slate-400`},`main.c (C11 Compiler)`)]),s(`span`,{class:`text-[10px] text-cyan-400 font-mono`},`GCC 13.2`)],-1),n(s(`textarea`,{"onUpdate:modelValue":l[0]||=e=>C.value=e,class:`flex-1 w-full bg-slate-900 text-emerald-300 font-mono text-xs p-4 leading-relaxed resize-none focus:outline-none custom-scrollbar`,spellcheck:`false`},null,512),[[f,C.value]])]),s(`div`,b,[s(`div`,x,[l[6]||=s(`div`,{class:`flex items-center gap-2`},[s(`span`,{class:`text-xs font-mono text-slate-300`},`📟 Terminal Output (stdout)`)],-1),s(`button`,{onClick:l[1]||=e=>T.value=``,class:`text-[11px] text-slate-400 hover:text-slate-200`},` Clear Console `)]),s(`div`,S,e(T.value),1)])])])]),_:1}))}});export{C as default};