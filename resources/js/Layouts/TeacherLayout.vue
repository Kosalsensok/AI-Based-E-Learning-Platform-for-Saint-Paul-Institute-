...
const teacherNav: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { name: 'All Courses', khName: 'All Courses', href: '/teacher/courses', iconUrl: '/images/nav/sub/all-courses.svg' },
      { name: 'Create New Course', khName: 'Create New Course', href: '/teacher/courses/create', iconUrl: '/images/actions/add-course.svg' },
      { name: 'Draft Courses', khName: 'Draft Courses', href: '/teacher/courses?tab=drafts', iconUrl: '/images/nav/sub/self-study.svg' },
      { name: 'Published Courses', khName: 'Published Courses', href: '/teacher/courses?tab=published', iconUrl: '/images/nav/sub/teacher-led.svg' },
      { name: 'Course Settings (Mode & Fee)', khName: 'Course Settings (Mode & Fee)', href: '/teacher/courses?tab=settings', iconUrl: '/images/nav/sub/roles.svg' },
    ]
  },
  {
    key: 'content',
    name: 'Content Delivery Module',
    khName: 'Content Delivery Module',
    ...
    children: [
      ...
      { name: 'AI English Content', khName: 'AI English Content', href: '/teacher/content?tab=ai-english', iconUrl: '/images/nav/sub/overview.svg', tag: '🤖' },
      { name: 'IT Coding Lab Content', khName: 'IT Coding Lab Content', href: '/teacher/content?tab=coding-lab', iconUrl: '/images/nav/sub/import-export.svg', tag: '💻' },
    ]
  },
  {
    key: 'assessment',
    name: 'Quiz & Assessment Module',
    khName: 'Quiz & Assessment Module',
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Student Progress', khName: 'Student Progress', href: '/teacher/students?tab=progress', iconUrl: '/images/nav/progress.svg' },
      { name: 'Completion Status', khName: 'Completion Status', href: '/teacher/students?tab=completion', iconUrl: '/images/nav/sub/roles.svg' },
      ...
      { name: 'Student Feedback', khName: 'Student Feedback', href: '/teacher/students?tab=feedback', iconUrl: '/images/nav/sub/overview.svg' },
    ]
  },
  {
    key: 'progress',
    name: 'Progress Tracking Module',
    khName: 'Progress Tracking Module',
  ...
  },
  {
    key: 'reports',
    name: 'Reports Module',
    khName: 'Reports Module',
    iconUrl: '/images/nav/analytics.svg',
    icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
    children: [
      { name: 'Student Report', khName: 'Student Report', href: '/teacher/reports?tab=student', iconUrl: '/images/nav/sub/students.svg' },
      { name: 'Course Report', khName: 'Course Report', href: '/teacher/reports?tab=course', iconUrl: '/images/nav/sub/all-courses.svg' },
      { name: 'Quiz Report', khName: 'Quiz Report', href: '/teacher/reports?tab=quiz', iconUrl: '/images/nav/quiz.svg' },
      { name: 'Attendance Report', khName: 'Attendance Report', href: '/teacher/reports?tab=attendance', iconUrl: '/images/nav/sub/history.svg' },
      { name: 'Payment Status Report', khName: 'Payment Status Report', href: '/teacher/reports?tab=payment-status', iconUrl: '/images/nav/payment.svg' },
      { name: 'Export PDF / Excel / CSV', khName: 'Export PDF / Excel / CSV', href: '/teacher/reports?tab=export', iconUrl: '/images/nav/sub/import-export.svg' },
    ]
  },
  {
    key: 'discussion',
    ...
    children: [
      { name: 'Student Questions', khName: 'Student Questions', href: '/teacher/discussion?tab=questions', iconUrl: '/images/nav/sub/overview.svg' },
      { name: 'Discussions', khName: 'Discussions', href: '/teacher/discussion?tab=discussions', iconUrl: '/images/nav/discussions.svg' },
      { name: 'Announcements', khName: 'Announcements', href: '/teacher/discussion?tab=announcements', iconUrl: '/images/actions/announcement.svg' },
      { name: 'Pinned Posts', khName: 'Pinned Posts', href: '/teacher/discussion?tab=pinned', iconUrl: '/images/nav/sub/policies.svg' },
      { name: 'Teacher Feedback', khName: 'Teacher Feedback', href: '/teacher/discussion?tab=feedback', iconUrl: '/images/nav/sub/roles.svg' },
    ]
  },
  {
    key: 'calendar',
    ...
    children: [
      { name: 'Class Schedule', khName: 'Class Schedule', href: '/teacher/calendar?tab=class-schedule', iconUrl: '/images/actions/announcement.svg' },
      { name: 'Quiz Schedule', khName: 'Quiz Schedule', href: '/teacher/calendar?tab=quiz-schedule', iconUrl: '/images/nav/quiz.svg' },
      { name: 'Assignment Deadline', khName: 'Assignment Deadline', href: '/teacher/calendar?tab=deadlines', iconUrl: '/images/nav/sub/policies.svg' },
      { name: 'Upcoming Events', khName: 'Upcoming Events', href: '/teacher/calendar?tab=events', iconUrl: '/images/nav/sub/semesters.svg' },
    ]
  },
  {
    key: 'earnings',
    ...
    children: [
      { name: 'Course / Subject Fee', khName: 'Course / Subject Fee', href: '/teacher/earnings?tab=fees', iconUrl: '/images/nav/analytics.svg' },
      { name: 'ABA Payment Status', khName: 'ABA Payment Status', href: '/teacher/earnings?tab=aba-status', iconUrl: '/images/actions/payment.svg' },
      { name: 'Student Payment List', khName: 'Student Payment List', href: '/teacher/earnings?tab=payments', iconUrl: '/images/nav/sub/students.svg' },
      { name: 'Payment Receipt', khName: 'Payment Receipt', href: '/teacher/earnings?tab=receipts', iconUrl: '/images/nav/sub/policies.svg' },
      { name: 'Pending Payments', khName: 'Pending Payments', href: '/teacher/earnings?tab=pending', iconUrl: '/images/nav/sub/failed.svg' },
      { name: 'Earnings Report', khName: 'Earnings Report', href: '/teacher/earnings?tab=overview', iconUrl: '/images/nav/payment.svg' },
    ]
  },
  {
    key: 'notifications',
    ...
    children: [
      { name: 'All Notifications', khName: 'All Notifications', href: '/teacher/notifications?tab=all', iconUrl: '/images/nav/notification.svg' },
      { name: 'Student Questions', khName: 'Student Questions', href: '/teacher/notifications?tab=questions', iconUrl: '/images/nav/sub/overview.svg' },
      { name: 'Payment Alerts', khName: 'Payment Alerts', href: '/teacher/notifications?tab=payments', iconUrl: '/images/actions/payment.svg' },
      { name: 'System Alerts', khName: 'System Alerts', href: '/teacher/notifications?tab=system', iconUrl: '/images/nav/sub/failed.svg' },
    ]
  },
  {
    key: 'profile',
    ...
    icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
    children: [
      { name: 'Personal Information', khName: 'Personal Information', href: '/teacher/profile?tab=personal', iconUrl: '/images/nav/sub/students.svg' },
      { name: 'Academic Assignment (Faculty/Dept/Major)', khName: 'Academic Assignment (Faculty/Dept/Major)', href: '/teacher/profile?tab=academic', iconUrl: '/images/nav/sub/roles.svg' },
      { name: 'Teaching History', khName: 'Teaching History', href: '/teacher/profile?tab=teaching-history', iconUrl: '/images/nav/sub/history.svg' },
      { name: 'Change Password', khName: 'Change Password', href: '/teacher/profile?tab=password', iconUrl: '/images/nav/sub/policies.svg' },
      { name: 'Notification Settings', khName: 'Notification Settings', href: '/teacher/profile?tab=notification-settings', iconUrl: '/images/nav/notification.svg' },
    ]
  }
]
...
const isSubActive = (subHref: string) => {
  ...
  if (subQuery) {
    return currentUrl.includes(subQuery)
  }

  // If subHref has NO query param, but currentUrl HAS tab= param, this non-query subHref should NOT be active
...
<template>
  ...
  <div class="min-h-screen bg-slate-900 text-slate-200 selection:bg-indigo-500/30">
    ...
    <aside :class="[isSidebarCollapsed ? 'w-20 overflow-visible' : 'w-72', 'fixed inset-y-0 left-0 z-50 hidden flex-col bg-slate-900/90 backdrop-blur-xl border-r border-slate-800 lg:flex transition-all duration-300']">
      ...
      >
        ...
        >
          ...
          <div v-show="!isSidebarCollapsed" class="transition-opacity duration-200 min-w-0">
            <span class="font-bold text-sm text-white block">E-LMS Teacher</span>
        ...
        <button
          ...
          :class="[
            isSidebarCollapsed
              ...
              : 'p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800 shrink-0 cursor-pointer',
          ...
          >
            ...
            <Link
              ...
              :class="[
                $page.url.startsWith(item.href!) 
                  ? 'bg-[#1E1B4B] text-[#818CF8] border border-[#818CF8]/30 font-bold shadow-md shadow-indigo-950/50' 
                  : 'text-slate-400 hover:text-[#F1F5F9] hover:bg-slate-800/70 border border-transparent font-medium',
            ...
            >
              <div :class="[isSidebarCollapsed ? 'justify-center w-full' : '', 'flex items-center gap-x-3 truncate']">
                <div class="relative flex items-center justify-center shrink-0">
                  ...
                  <svg 
                    :class="[
                      $page.url.startsWith(item.href!) ? 'text-[#818CF8]' : 'text-slate-500 group-hover:text-slate-300',
                      item.iconUrl ? 'hidden' : '',
              ...
              <span 
                ...
                class="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-rose-500 ring-2 ring-slate-900 animate-pulse"
              ></span>
            </Link>
            ...
            <div v-else class="space-y-1 w-full flex flex-col items-center">
              ...
              >
                <div :class="[isSidebarCollapsed ? 'justify-center w-full' : '', 'flex items-center gap-x-3 truncate']">
                  <div class="relative flex items-center justify-center shrink-0">
                    ...
                    <svg 
                      :class="[
                        isChildActive(item.children) ? 'text-[#818CF8]' : 'text-slate-500 group-hover:text-slate-300',
                        item.iconUrl ? 'hidden' : '',
                        'h-5 w-5 shrink-0 transition-colors'
                      ]"
                      fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                ...
                <div v-show="!isSidebarCollapsed" class="flex items-center gap-1.5">
                  ...
                  <svg
                    :class="[
                      expandedModules[item.key!] ? 'rotate-180 text-[#818CF8]' : 'text-slate-500 group-hover:text-slate-300',
              ...
              <div
                ...
                class="relative ml-5 pl-3.5 space-y-1 my-1.5 transition-all duration-300 border-l border-slate-800/80 w-[calc(100%-1.25rem)]"
              >
                <div
                  ...
                  <Link
                    ...
                    :class="[
                      isSubActive(sub.href)
                        ? 'bg-[#1E1B4B]/80 text-[#818CF8] font-bold border border-[#818CF8]/30 shadow-xs'
                        : 'text-slate-400 hover:text-[#F1F5F9] hover:bg-slate-800/60 border border-transparent font-medium',
              ...
              <div class="relative bg-slate-900/95 backdrop-blur-xl border border-slate-700/80 rounded-2xl p-3 shadow-2xl ring-1 ring-slate-800/80">
                ...
                <div class="relative z-20 space-y-1 max-h-[70vh] overflow-y-auto custom-scrollbar pr-1">
                  <Link
                    ...
                    :class="[
                      isSubActive(sub.href)
                        ? 'bg-indigo-500/15 text-[#818CF8] font-bold border border-[#818CF8]/30'
      ...
      <div :class="[isSidebarCollapsed ? 'px-0 py-3' : 'p-3.5', 'mt-auto border-t border-slate-800 bg-[#0B0F19]']">
        <div :class="[isSidebarCollapsed ? 'flex-col justify-center items-center gap-2.5 w-full' : 'justify-between gap-3', 'flex items-center']">
          <div class="flex items-center gap-3 min-w-0 flex-1">
            ...
            <div v-show="!isSidebarCollapsed" class="flex-1 min-w-0">
              <p class="font-bold text-slate-100 text-xs truncate leading-snug">{{ user.name || 'Sophea Teacher' }}</p>
              <p class="text-[10px] text-slate-400 truncate leading-snug">{{ user.email || 'teacher@elms.com' }}</p>
            </div>
          </div>
          ...
          <button
            ...
            @click="logout"
            title="Log Out (⎋)"
            class="p-2 text-slate-400 hover:text-red-400 hover:bg-slate-800/80 rounded-lg transition-all shrink-0 flex items-center justify-center cursor-pointer group"
          >
    ...
    >
      ...
      <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar">
        <template v-for="item in teacherNav" :key="item.key">
          <Link
            ...
            @click="sidebarOpen = false"
            :class="[
              $page.url.startsWith(item.href!) ? 'bg-[#1E1B4B] text-[#818CF8] font-bold border border-[#818CF8]/30' : 'text-slate-400 hover:text-[#F1F5F9] hover:bg-slate-800/60',
          ...
          <div v-else class="space-y-1">
            ...
            >
              ...
              <div class="flex items-center gap-1.5">
                ...
                <svg :class="[expandedModules[item.key!] ? 'rotate-180' : '', 'w-4 h-4 transition-transform text-slate-500']" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
              </div>
            </button>
            <div v-show="expandedModules[item.key!]" class="pl-4 ml-4 space-y-1.5 my-1.5 border-l border-slate-800/80">
              <Link
                v-for="sub in item.children"
                :key="sub.href"
                :href="sub.href"
                @click="sidebarOpen = false"
                :class="[
                  isSubActive(sub.href) ? 'bg-[#1E1B4B]/80 text-[#818CF8] font-bold border border-[#818CF8]/30 shadow-xs' : 'text-slate-400 hover:text-slate-100 hover:bg-slate-800/60 border border-transparent font-medium',
      ...
      <!-- Mobile Footer -->
      <div class="p-3.5 border-t border-slate-800 bg-[#0B0F19] flex items-center justify-between">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div class="min-w-0">
            <p class="font-bold text-slate-100 text-xs truncate">{{ user.name || 'Sophea Teacher' }}</p>
            <p class="text-[10px] text-slate-400 truncate">{{ user.email || 'teacher@elms.com' }}</p>
          </div>
        </div>
      ...
      <div class="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8 gap-4">
        ...
        <div class="flex items-center gap-3.5 min-w-0">
          ...
          <div class="hidden sm:flex items-center gap-2 text-xs font-medium truncate">
            <span class="text-slate-400 font-normal">Teacher</span>
        ...
        <!-- Right Side: Online Status, Language Switcher, Fullscreen, Notifications, User Profile -->
        <div class="flex items-center gap-1.5 sm:gap-2">
                  ...
                  <Link :href="notif.link" @click="isNotificationOpen = false">
                    <div class="flex items-start gap-3">
                      <div :class="[
                        ...
                        notif.type === 'assignment' ? 'bg-amber-500/20 text-amber-400' : 'bg-indigo-500/20 text-indigo-400',
          ...
          <!-- User Profile Dropdown Avatar (👤 Sophea Teacher ˅) -->
          <div class="relative ml-1">
            ...
            >
              <div class="relative shrink-0">
                <img
                  :src="user.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name || 'Sophea Teacher')}&background=6366f1&color=fff`"
                  alt="Teacher Profile"
            ...
            >
              <div class="px-4 py-3 border-b border-slate-700/80 bg-gradient-to-r from-indigo-900/30 to-purple-900/30">
                <div class="flex items-center gap-3">
                  ...
                  />
                  <div class="flex-1 min-w-0">
                    <h4 class="text-xs font-bold text-white truncate">{{ user.name || 'Sophea Teacher' }}</h4>
                    <p class="text-[11px] text-slate-400 truncate">{{ user.email || 'teacher@elms.com' }}</p>
              ...
              <div class="py-1.5 border-b border-slate-700/60 text-xs space-y-0.5">
                <Link
                  href="/teacher/profile?tab=info"
                  @click="isProfileOpen = false"
                  class="flex items-center gap-2.5 px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors group"
                >
                  <svg class="w-4 h-4 text-sky-400 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                ...
                <Link
                  ...
                  class="flex items-center gap-2.5 px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors group"
                >
                  <svg class="w-4 h-4 text-teal-400 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                ...
                <Link
                  ...
                  class="flex items-center gap-2.5 px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors group"
                >
                  <svg class="w-4 h-4 text-indigo-400 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
              ...
              <div class="py-1 border-b border-slate-700/60 text-xs">
                <Link
                  ...
                  class="flex items-center gap-2.5 px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors group"
                >
                  <svg class="w-4 h-4 text-emerald-400 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
              ...
              <div class="pt-1">
                <button
                  @click="logout"
                  class="w-full flex items-center gap-2.5 px-4 py-2 text-xs text-red-400 hover:bg-red-900/30 transition-colors font-bold text-left cursor-pointer group"
                >
                  <svg class="w-4 h-4 text-red-400 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
