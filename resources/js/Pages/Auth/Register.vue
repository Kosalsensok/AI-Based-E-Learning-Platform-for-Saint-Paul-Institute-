...
<template>
  <div class="min-h-screen flex items-center justify-center bg-slate-100/90 dark:bg-[#070D1E] text-slate-900 dark:text-slate-100 p-4 sm:p-6 lg:p-8 relative font-sans overflow-x-hidden transition-colors duration-500">
    ...
    <!-- Master Centered Register Card (Clean, High-Contrast & Official Layout) -->
    <div class="max-w-lg w-full max-h-[90vh] p-[1px] rounded-3xl bg-gradient-to-b from-blue-500/40 via-indigo-500/20 to-purple-500/30 dark:from-blue-500/30 dark:via-slate-800/40 dark:to-indigo-500/20 shadow-2xl shadow-slate-900/10 dark:shadow-black/60 relative z-10 my-auto transition-all flex flex-col">
      <div class="w-full bg-white/95 dark:bg-[#0E172E]/95 backdrop-blur-2xl rounded-[23px] p-6 sm:p-7 flex flex-col justify-center relative z-20 space-y-3.5 transition-colors overflow-y-auto max-h-[90vh] custom-scrollbar">
